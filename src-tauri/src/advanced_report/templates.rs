...
pub(crate) struct BuiltinAdvancedTemplate {
    ...
    pub(crate) style_summary: &'static str,
    pub(crate) style_md: &'static str,
    pub(crate) prompt_md: &'static str,
    pub(crate) default_report_period: &'static str,
    pub(crate) default_output_shape: &'static str,
    pub(crate) requires_raw_notes_consent: bool,
    pub(crate) default_capabilities: &'static [&'static str],
    pub(crate) optional_capabilities: &'static [&'static str],
}
